package com.evilkissyou.airplanetelegrambot.constants;
...
public final class Constants {
    ...
    public static final String COMMAND_PROGRESS = "/statistics";
    public static final String COMMAND_RESET = "/reset";
    public static final String COMMAND_HELP = "/help";
    public static final String GET_AIRPLANE_INFO = "Get airplane info";
